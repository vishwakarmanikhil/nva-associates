...
export default function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-slate-50 py-28 dark:bg-slate-950">
      {/* Glow */}
      <div className="pointer-events-none absolute inset-0 flex justify-center">
        <div
          className="
            absolute -bottom-24
            h-64 w-[90vw] max-w-[720px]
            rounded-full
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <p
          ...
          "
        >
          Get started with a free consultation today. Our experts are ready
          to help you stay compliant and grow with confidence.
        </p>
        ...
        <div className="mt-10 flex gap-2 justify-center">
          ...
          <a href="tel:9082024196" className="flex flex-row gap-1
              ...
              <a href="" target="_blank" className="flex flex-row gap-1
                rounded-md border border-slate-300 px-6 py-3
                text-sm text-slate-700
                hover:bg-slate-100 transition
                dark:border-slate-700 dark:text-slate-300
